...
Description: This script triggers a GitHub Actions workflow using the GitHub API. It takes parameters for the repository name,
             environment, name of workflow file, and personal access token (PAT). 
...
Usage: .\Trigger_WF_From_GH_API.ps1 -repo_name "your_repo_name" -environment "your_environment" -workflow_file "workflow yml file" -pat_token "your_pat_token"
#>
